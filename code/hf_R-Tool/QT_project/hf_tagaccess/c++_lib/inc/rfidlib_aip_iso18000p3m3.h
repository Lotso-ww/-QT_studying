...
err_t RFIDLIB_API ISO18000p3m3_AddBaseInvenSelectParam(RFID_DN_HANDLE hIso18000p3m3InvenParam , BYTE num, BYTE data);
...
err_t RFIDLIB_API ISO18000p3m3_ParseTagDataReportEx(RFID_DN_HANDLE hTagReport,
												  DWORD *aip_id,
												  DWORD *tag_id,
												  DWORD * ant_id,
												  DWORD *metaFlags,
