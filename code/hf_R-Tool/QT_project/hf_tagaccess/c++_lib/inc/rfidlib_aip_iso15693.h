...
extern "C" {
    ...
    DWORD RFIDLIB_API ISO15693_GetLibVersion(LPTSTR buf ,DWORD nSize )  ;
    /*
    ...
    */
    ...
    RFID_DN_HANDLE RFIDLIB_API ISO15693_CreateInvenParamV2(RFID_DN_HANDLE hInvenParamSpecList,
                                                                BYTE AntennaID,
                                                                BOOLEAN en_afi,
                                                                BYTE afi,
                                                                BYTE slot_type,
    ...
    err_t RFIDLIB_API ISO15693_InvenParam_EnableStrengthSort(RFID_DN_HANDLE hIso15693InvenParam, BOOLEAN isFilter);
     ...
     err_t RFIDLIB_API TIHFIPLUS_Write2Blocks(RFID_READER_HANDLE hr ,
        ...
        err_t RFIDLIB_API ST25DV04K_ReadConfiguration(RFID_READER_HANDLE hr, /*in */
            ...
            //EN4237SLIC and EN4237SLIX
                ...
                RFID_DN_HANDLE RFIDLIB_API NXPICODESLI_CreateTAWritePassword(RFID_DN_HANDLE hTagAccessSet,BYTE pwdNo,DWORD pwd);
